...
csv_file_path = os.path.abspath(dicom_csv_dir + '/OAI_MR_QA_Images_Complete_RAAAs_Fields.csv')

# fetch a list of dicom files
dicom_file_paths = []
for root, dirs, files in os.walk('C:/Users/schroepferna/OAI/OAI_MR_QA_Images_Extracted/RAAAs'):
    for file in files:
